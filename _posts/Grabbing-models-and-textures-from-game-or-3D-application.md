...
![Img 3dripper](./assets/gmt_3dripper-first.png?raw=true)
...
![Img ninja ripper](./assets/gmt_ninjaripper-first.png?raw=true)
...
![Img compare](./assets/gmt_compare-first.png?raw=true)
...
![Img game screenshot](./assets/gmt_game_screenshot.jpg)

![Img grabbed screenshot](./assets/gmt_grabbed_screenshots.png)

Drag and drop photos into Agisoft Metashape do a **Photo alignment** which will generate a **Point-cloud data**.

![Img alignment](./assets/gmt_image_alignment.png)

After Point-cloud data just **build Mesh**

![Img output](./assets/gmt_output.jpg)
...
![Img screenshoted path](./assets/gmt_screenshoted_path.png)
![Img recomputed textures](./assets/gmt_output_recomputed_textures_8k.png)

So a little comparsion for final image quality or result.
![Img comparsion](./assets/gmt_comparsion.png)
...
![Img reduced polygons](./assets/gmt_reduced_polygons_c4d.png)
