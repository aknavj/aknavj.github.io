...
![](./assets/gmt_3dripper-first.png?raw=true)
...
![](./assets/gmt_ninjaripper-first.png?raw=true)
...
![](./assets/gmt_compare-first.png?raw=true)
...
![](./assets/gmt_screenshoted_path.png)
![](./assets/gmt_output_recomputed_textures_8k.png)

So a little comparsion for final image quality or result.
![](./assets/gmt_comparsion.png)
...
![](./assets/gmt_reduced_polygons_c4d.png)
