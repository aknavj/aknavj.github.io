...
![](./assets/images/rippingtools/3dripper-first.png?raw=true)
...
![](./assets/images/rippingtools/ninjaripper-first.png?raw=true)
...
![](./assets/images/rippingtools/compare-first.png?raw=true)
...
![](./assets/images/photogrammery/game_screenshot.jpg)

![](./assets/images/photogrammery/grabbed_screenshots.png)

Drag and drop photos into Agisoft Metashape do a **Photo alignment** which will generate a **Point-cloud data**.

![](./assets/images/photogrammery/image_alignment.png)

After Point-cloud data just **build Mesh**

![](./assets/images/photogrammery/output.jpg)
...
![](./assets/images/photogrammery/screenshoted_path.png)
![](./assets/images/photogrammery/output_recomputed_textures_8k.png)

So a little comparsion for final image quality or result.
![](./assets/images/photogrammery/comparsion.png)
...
![](./assets/images/photogrammery/reduced_polygons_c4d.png)
